   ...
   public class CommandAndSpecificationTests
    {
        ...
        {
            var eqs0=new ElementStackSpecification("element",1,"primary",null);
            Assert.AreEqual(0,eqs0.Depth);

            var eqs1 = new ElementStackSpecification("element", 1, "primary_foo", null);
            Assert.AreEqual(1, eqs1.Depth);

            var eqs2 = new ElementStackSpecification("element", 1, "primary_foo_bar", null);

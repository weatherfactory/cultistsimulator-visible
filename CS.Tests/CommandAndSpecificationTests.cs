   ...
   public class CommandAndSpecificationTests
    {
        ...
        {
            var eqs0=new ElementQuantitySpecification("element",1,"primary");
            Assert.AreEqual(0,eqs0.Depth);

            var eqs1 = new ElementQuantitySpecification("element", 1, "primary_foo");
            Assert.AreEqual(1, eqs1.Depth);

            var eqs2 = new ElementQuantitySpecification("element", 1, "primary_foo_bar");

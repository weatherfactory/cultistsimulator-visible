...
// 2021-06-28, 1.8.6 - Removed deprecated code.
    ...
    void Awake()
    {
        ...
        if (!gua.analyticsDisabled)
        {
                ...
                !PlayerPrefs.HasKey(prefKey))
            {
                ...
                sendSystemInfoEvent(category, "graphicsMultiThreaded", SystemInfo.graphicsMultiThreaded ? "yes" : "no", SystemInfo.graphicsMultiThreaded ? 1 : 0); // Unity 5.0+

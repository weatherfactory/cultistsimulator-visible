	...
	public class SteamSpyComponent : ListViewItem, IViewData<SteamSpyItem>
	{
		...
		public override Graphic[] GraphicsBackground
		{
			get
			{
				return new Graphic[]
				{
					NameAdapter.transform.parent.GetComponent<Graphic>(),
					ScoreRankAdapter.transform.parent.GetComponent<Graphic>(),
					OwnersAdapter.transform.parent.GetComponent<Graphic>(),
					PlayersAdapter.transform.parent.GetComponent<Graphic>(),
					PlayersIn2WeekAdapter.transform.parent.GetComponent<Graphic>(),
					TimeIn2WeekAdapter.transform.parent.GetComponent<Graphic>(),
				};
			}
		}

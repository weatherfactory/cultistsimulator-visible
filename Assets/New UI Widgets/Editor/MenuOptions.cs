...
namespace UIWidgets
{
	...
	public static class MenuOptions
	{
		...
		{
			Utilities.CreateWidgetFromPrefab(prefab, true, ConverterTMPro.Widget2TMPro);
		}
		...
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Miscellaneous/ScrollRectPaginator", false, 5020)]
		...
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Miscellaneous/ScrollRectNumericPaginator", false, 5030)]
		...
		/// Create Sidebar.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Miscellaneous/Sidebar", false, 5040)]

namespace UIWidgets
{
	...
	public class DateTimeScroller : DateScroller
	{
		...
		protected DateTime AddHours(DateTime date, int hours)
		{
		...
		/// <returns>New date.</returns>
		protected DateTime AddMinutes(DateTime date, int minutes)
		{
		...
		/// <returns>New date.</returns>
		protected DateTime AddSeconds(DateTime date, int seconds)
		{

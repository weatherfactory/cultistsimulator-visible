namespace UIWidgets
{
	...
	public class DateScroller : DateBase
	{
		...
		protected DateTime AddYears(DateTime date, int years)
		{
		...
		/// <returns>New date.</returns>
		protected DateTime AddMonths(DateTime date, int months)
		{
		...
		/// <returns>New date.</returns>
		protected DateTime AddDays(DateTime date, int days)
		{

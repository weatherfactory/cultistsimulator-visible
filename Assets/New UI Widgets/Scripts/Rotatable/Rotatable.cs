namespace UIWidgets
{
	...
	/// W - west (left).
	/// </summary>
	[AddComponentMenu("UI/New UI Widgets/Rotatable")]
...
#pragma warning restore 0618
		...
		protected bool CanChangeCursor
		{
			get
			{
				return UICursor.CanSet(this) && Input.mousePresent && IsCursorOver;
			}
		}
		...
		protected virtual void LateUpdate()
		{
			...
			Vector2 point;
			if (!RectTransformUtility.ScreenPointToLocalPointInRectangle(Target, Input.mousePosition, CurrentCamera, out point))
			{
				return;
			}

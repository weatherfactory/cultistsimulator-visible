namespace EasyLayoutNS
{
	...
	public class EasyLayout : LayoutGroup, INotifyPropertyChanged
	{
		...
		public float MarginFullHorizontal
		{
			get
			{
				var margin = Symmetric ? (Margin.x + Margin.x) : (MarginLeft + MarginRight);
				return margin + MarginInner.Horizontal;
			}
		}
		...
		public float MarginFullVertical
		{
			get
			{
				var margin = Symmetric ? (Margin.y + Margin.y) : (MarginTop + MarginBottom);
				return margin + MarginInner.Vertical;
			}
		}

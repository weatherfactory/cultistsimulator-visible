namespace UIWidgets
{
	...
	[AddComponentMenu("UI/New UI Widgets/Resizable Handles")]
	public class ResizableHandles : UIBehaviourConditional
	{
		...
		protected void SetHandleState(DragListener handle, bool state)
		{
			if (handle != null)
			{
		...
		/// </summary>
		/// <param name="handle">Handle.</param>
		public void DisableHandle(DragListener handle)
		{
			if (handle != null)
			{

	...
	public class ClassField : IFormattable
	{
		...
		public static ClassField Create(FieldInfo field)
		{
			...
			var result = new ClassField()
			{
				...
				FieldTypeName = Utilities.GetFriendlyTypeName(field.FieldType),
		...
		public static ClassField Create(PropertyInfo property)
		{
			...
			var result = new ClassField()
			{
				...
				FieldTypeName = Utilities.GetFriendlyTypeName(property.PropertyType),
		...
		public string ToString(string format, IFormatProvider formatProvider)
		{
			switch (format)
			{
				...
				case "WidgetClass":
					return Utilities.GetFriendlyTypeName(WidgetClass);

    ...
    public Ending GetEndingById_old(string endingFlag)
    {
        ...
        if (endingFlag == "majorforgevictory")
            return new Ending(endingFlag, "THE DAWN",
                "The Savage Door is an old wound, and it does not open easily, but once again it opens. Even the Gods-from-stone employed it, " +
                "and how many before them? Our Shaper passes both the Door and the Gate, and is become a Name of the Forge, and a single place has opened in the ranks of the Long. " +
                "It is not for me. I am Nowhere. Nowhere is lit by lamps of black nephrite. " +
                "In Nowhere, we hear the voices prophesying. In Nowhere it is very cold. But it is always possible to be deader. \n" +
                ...
                , "madrugad", EndingFlavour.Grand, "DramaticLightCool", NoonConstants.A_ENDING_MAJORFORGEVICTORY);
        ...
        if (endingFlag == "majorgrailvictory")
            return new Ending(endingFlag, "THE FEAST FULFILL'D",
                ...
                , "flowermaker", EndingFlavour.Grand, "DramaticLightCool", NoonConstants.A_ENDING_MAJORGRAILVICTORY);


        if (endingFlag == "majorlanternvictory")
            return new Ending(endingFlag, "IN THE THIRD MODE",
                "The Glory is a question, and we all of us, the Witnesses and I, answered Yes, as we fuelled our Illuminated One. They are the light now in the Watchman's hand, more Glorious than ever, " +
                "and we are wax and eggshells. But the Chandler's secret pilgrimage will gather us one by one and assemble us in the image of the one who watches and does not act. Our time has passed " +
                "and hers has not yet come, but I think, very soon, she will suggest an arrangement. \n" +
        "[Congratulations on a major victory. Perhaps one in twenty players players ever achieve even a minor victory: fewer still rise this far. We, and Janus, salute you.]",
                "vagabond", EndingFlavour.Grand, "DramaticLightCool", NoonConstants.A_ENDING_MAJORLANTERNVICTORY);
